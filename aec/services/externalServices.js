...
external.constant("servicesConfig", {
    ...
    user : { 
        Id: 1, 
        name: 'AeC - Relacionamento com responsabilidade',
        logo: {title: "AEC", img: "assets/images/logo.png"},        
        layout: {
            type: 'center',
            header: {
                login: true,
                user:{tpl: 'tpl-dropdownmenu', classe: 'links', titleref: 'apelido',
                    menu: [
                        ...
                        {title: 'Compras Promocionais', classe: 'compraspromocao', url: 'vantagem', ref: 'vantagem'},
                ...
                lists: [
                    {
                        title: 'Informações', classe:"info", size: 3, list: [
                            ...
                            {type: 'nav', title: 'Institucional', classe:'institucional', url: 'institucional', ref:'institucional' /*linkexterno: true*/},
                            {type: 'nav', title: 'Seja um parceiro', classe:'parceiro', url: '', ref:'parceiro'},
                            {type: 'nav', title: 'Trabalhe conosco', classe:'trabalheconosco', url: '', ref:'trabalheconosco'},
                        ]
                    },
                    {
                        title: 'AeC', classe:"website", size: 3, list: [
                            ...
                            {type: 'nav', title: 'Compras Promoçionais', classe:'promocao', url: '', ref: 'vantagem'},
                        ]
                    },
                    {
                        title: 'Redes Sociais', classe:"socialmedia", size: 3, list: [
                            {title: 'facebook.com.br/aec', classe:'facebook', url: 'facebook.com.br/aec', linkexterno: true, icon: 'facebook'},
                            {title: 'twitter.com/aec', classe:'twitter', /*url: 'twitter.com/aec', linkexterno: true,*/ icon: 'twitter'},
                        ]
                    },
                    {
                        title: 'Contato', classe:"help", size: 3, list: [
                            {type: 'nav', title: 'Fale conosco', classe:'contato', url: 'contato', ref:'contato'},
                            {type: 'nav', title: 'Dúvidas frequentes', classe:'duvidas', url: '', ref: 'duvidas'},
...
- validar resgate antes de calcular
            ...
            links: {
                ...
                //EXTERNOS
                institucional: {name: 'institucional', title: "Institucional", href:"/institucional", pageclose: false, navactive: 'institucional'},
                ...
                vantagem: {name: 'vantagem', title: "compras promocionais", href:"/compras-promocionais/catalogo:parameter/categoria:parameter", hrefDefault: '/compras-promocionais/catalogo:CB/categoria:1', pageclose: true, navinternaactive: 'vantagem', navactive: 'vantagem',},
            ...
            nav: [
                ...
                {type: 'nav', title: 'Institucional', classe: 'institucional', url: 'institucional', ref:'institucional'},
                {type: 'nav', title: 'Home', classe: 'home', url: 'index', ref:'index'},
            ],
            partials: {
                ...
                menucategoriavantagem: {
                    ...
                    service: {
                        call: {objresult: 'load',
                            urls: [
                                {url: 'categoria/find/tipopremio/', parameter: 'S'},
                            ]                            
                        },
                    },
                    aditionals: {
                        field: {type: 'menu', aliasclassheader: 'titleheader',  nameclass: 'description', urldirect: true,
                ...
                menupremiosvantagem: {
                    ...
                    aditionals: {
                        field: {type: 'menu', aliasclassheader: 'titleheader', nameclass: 'description', hideImage: true, url: 'vantagem',
                            insertDinamic: {ref: 'name', classe: 'value', 
                                menuactiveaut: [
                    ...
                    table: {id: 'catalogo-vantagem',tpl: 'tpl-list-form', classe:'list-box catalogo-vantagem', clickbtn: true, 
                        ...
                        aditionals: {
                            field: {
                                ...
                                btnConditional: true,
                                btns: [
                                    {title: 'Resgatar', visibled: true, classe: 'btn-secondary', disabled: true, openmodal:true, url: 'condicaovantagemresgatar', /*url: "http://www.aec.com.br", target: 'blank'*/
                                        viewConditional: [
                                            { name: 'params', paramsName: 'resgatar', searchThis: true, events:{name: 'alias', value: 'testeeeee'}}
                                        ],
                                    },
                                    {title: 'Comprar', visibled: true, classe: 'btn-secondary', disabled: true, openmodal:true, url: 'condicaovantagemcomprar',/*url: "http://www.aec.com.br", target: 'blank'*/
                                        viewConditional: [
                                ...
                                result: {
                                    line:[
                                        ...
                                        {field: [
                                            ...
                                            +'<p>2.1. O programa In Mais é de livre adesão a qualquer pessoa física que possua um CPF (Cadastro de Pessoas Físicas do Ministério da Fazenda) próprio e válido, que efetuar o cadastro no programa através do site www.aec.com.br , ou qualquer plataforma disponibilizada e devidamente habilitada pelo Programa.</p>'
                ...
                infocontato: {id: 'info-contato', tpl:'tpl-inner',                    
                    ...
                    +'<a href="mailto:atendimento@aec.com.br" target="_blank">atendimento@aec.com.br</a><br/>'
                            ...
                            {classe:'bg-form', form: [
                                {
                                    style: 'inline',
                                    campos: [
                                        {nameTpl: 'inputtext', type:'text', classe:'inputtext', name:'alias', id: 'alias', parameterclicked: true, parameter: 'alias', ignoresave: true, labelHide: true, size: 12, inputSize: 12},
                                ...
                                },
                                {
                                    style: 'inline col-md-12 box-scroll',
                                    campos: [
                                        {nameTpl: 'inputtext', name:'textoCondicaoEntrega', id: 'textoCondicaoEntrega', classe:'listRegulamento', parameterclicked: true, parameter: 'params', nameparams: 'textoCondicaoEntrega', ignoresave: true, hidden: false, labelHide: true,  size: 12, inputSize: 12,
                                            conditionalShow: {parameter: 'value', hide : ['textoCondicaoEntrega', 'flagcondicaoEntrega']},
                                        },
                                    ]
                                },
                                {
                                ...
                                },
                                {
                                    style: 'inline col-md-12',
                                    campos: [
                                        {nameTpl: 'inner', id: 'aviso', name:'aviso', ignoresave: true, noclearvalue: true, lineValue: 'Após clicar em Confirmar, você será direcionado automaticamente para o site do parceiro.'},
                                    ]
                                },
            ...
            pages: {
                login: {
                    ...
                    content: {id: 'box-login', tpl: 'tpl-form', classe: 'box box-default form login', 
                        header: {
                            title: {classe: 'text-center', text: 'Seja bem vindo(a) ao AeC'}
                        },
                        btns: [
                ...
                contato: {
                    ...
                    content: {tpl: 'tpl-form', classe: 'contato',
                        ...
                        detail: [
                            {
                                title: {
                                    description: {text: 'Em caso de dúvidas entre em contato pelo telefone <strong>(11) 2671-0400 </strong> ou preencha os campos abaixo e aguarde que em breve entraremos em contato'}
                                },
                                form: [
                                    {
                                        style: 'inline',
                                            ...
                                            {classe: 'titleBorderNn', 
                                                ...
                                                form: [
                                                    ...
                                                    },
                                                    {
                                                        style: 'inline ',
                                                        campos: [
                                                            {nameTpl: 'input', type: 'text', name:'cartaoCpf', id: 'cartaoCpf', labelName: 'CPF:', required: true, size: 12, inputSize: 3, labelSize: 2, disabled: true},
                                                        ]
                                                    },
                                                    {
                                                        style: 'inline',
                                                        campos: [
                                                            {nameTpl: 'input', type: 'text', name:'cartaoRg', id: 'cartaoRg', labelName: 'Número do RG:', maxlength:20, required: true, size: 12, inputSize: 3, labelSize: 2}
                                                        ]
                                                    },
                                                    {
                                                        style: 'inline',
                                                    ...
                                                    },
                                                    {
                                                        style: 'inline',
                                                        campos: [
                                                            {nameTpl: 'input', type: 'text', name:'cartaoCep', id: 'cartaoCep', labelName: 'CEP:', required: true, size: 6, inputSize: 6, labelSize: 4},
                                                    ...
                                                    },
                                                    {
                                                        style: 'inline',
                                                        campos: [
                                                            {nameTpl: 'input', type: 'tel', name:'cartaoTelefoneResidencial', id: 'cartaoTelefoneResidencial', labelName: 'Telefone Residencial:', required: true, size: 12, inputSize: 3, labelSize: 2},
                                                        ]
                                                    },
                                                    /*{
                                                        style: 'inline',
                            ...
                            content: {tpl: 'tpl-page-texts', title: 'Como quer resgatar seus pontos?', subtitle: '<p>Escolha uma das opções abaixo e veja como é fácil aproveitar tudo o que o In Mais tem a te oferecer!</p>',
                                detail: [
                                    {tpl: 'tpl-form', classe: 'form-checkout', fieldCallHidden: true,
                                        ...
                                        btns: [
                                            {name: 'save', openmodal: true, issaveform:true, url: 'resgateconfirm', title: 'Confirmar', visibled: true, classe: 'btn-primary',
                                        ...
                                        /*fieldsInteraction: [
                                            {field: 'calcularpontoscc', interaction: 'enable', fields: ['cartao_pre_pago']},
                                            {field: 'qtdade', interaction: 'enable', fields: ['cartao_pre_pago']}
                                        ],*/
                                        detail: [
                                            {classe:'bg-form', form: [
                                                    {
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        campos: [
                                                            {nameTpl: 'input', classe:'inputtext', type: 'pontos', name:'qtdade', id: 'qtdade', savetype: 'number', addParamsResult: true, disabled: false, size: 10, inputSize: 6, labelSize: 6,
                                                                ...
                                                                clearResult: ['qtpon', 'qtpremio_total', 'flag']
                                                            },
