...
(function(factory) {
    ...
    Slick.prototype.loadSlider = function() {
        ...
        _.setPositionActive(); //INICIAR APARTIR DO ITEM ATIVO
        _.setPosition();
    ...
    Slick.prototype.setPositionActive = function() {
        ...
        _.$slides.each(function(index, element) {
            ...
            if(link.hasClass('active')){
                newIniSlide = index;
                _.currentSlide = (newIniSlide > _.options.slidesToShow - 1 ? newIniSlide - _.options.slidesToShow/_.options.slidesToShow*2: 0);
                //CALCULO PARA MARCAR O NOVO INICIO DO CARROSEL ONDE POSSA SER VISUALIZADO O ELEMENTO ATIVO
            }
        });
    };
